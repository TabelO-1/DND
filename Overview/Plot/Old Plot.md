...
They will do missions that help a faction(or multiple) and gain Reputation points(hidden from players) with that faction. Missions will either strengthen a faction or hurt another(or sometimes both(Actualy strength will be hidden from players)).
